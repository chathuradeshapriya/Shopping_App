...
//
// List<Welcome> productFromJson(String str) => List<Welcome>.from(json.decode(str).map((x) => Welcome.fromJson(x)));
//
// String productFromJson(List<Welcome> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    brand: brandValues.map[json["brand"]] ?? Brand.MAYBELLINE,
    name: json["name"],
    price: json["price"],
